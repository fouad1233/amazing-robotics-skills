<!-- Vendored from huggingface/OpenEnv @ main
     Path:    .claude/skills/generate-openenv-env/SKILL.md
     Licence: BSD-3-Clause
     Source:  https://github.com/huggingface/OpenEnv/blob/main/.claude/skills/generate-openenv-env/SKILL.md
