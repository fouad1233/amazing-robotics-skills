<!-- Vendored from huggingface/skills @ main
     Path:    hf-mcp/skills/hf-mcp/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/huggingface/skills/blob/main/hf-mcp/skills/hf-mcp/SKILL.md
