<!-- Vendored from NVIDIA/TensorRT-LLM @ main
     Path:    .claude/skills/ad-add-fusion-transformation/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/NVIDIA/TensorRT-LLM/blob/main/.claude/skills/ad-add-fusion-transformation/SKILL.md
