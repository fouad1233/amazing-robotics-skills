<!-- Vendored from NVIDIA/TensorRT-LLM @ main
     Path:    .claude/skills/kernel-tileir-optimization/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/NVIDIA/TensorRT-LLM/blob/main/.claude/skills/kernel-tileir-optimization/SKILL.md
