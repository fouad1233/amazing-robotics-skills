<!-- Vendored from NVIDIA/TensorRT-LLM @ main
     Path:    .claude/skills/perf-nsight-compute-analysis/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/NVIDIA/TensorRT-LLM/blob/main/.claude/skills/perf-nsight-compute-analysis/SKILL.md
