<!-- Vendored from NVIDIA/TensorRT @ main
     Path:    .agents/skills/trt-cpp-runtime-quickstart/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/NVIDIA/TensorRT/blob/main/.agents/skills/trt-cpp-runtime-quickstart/SKILL.md
