<!-- Vendored from isaac-sim/IsaacSim @ main
     Path:    skills/meta-skills/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/isaac-sim/IsaacSim/blob/main/skills/meta-skills/SKILL.md
...
| hardcoded image review endpoint | `$IMAGE_SERVER_URL` (placeholder OK; never bake the endpoint) |
