<!-- Vendored from NVIDIA-AI-IOT/DeepStream_Coding_Agent @ main
     Path:    skills/deepstream-dev/SKILL.md
     Licence: CC-BY-4.0
     Source:  https://github.com/NVIDIA-AI-IOT/DeepStream_Coding_Agent/blob/main/skills/deepstream-dev/SKILL.md
