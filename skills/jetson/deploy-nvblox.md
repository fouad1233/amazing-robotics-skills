<!-- Vendored from Seeed-Projects/Seeed-Jetson-DevelopTool @ main
     Path:    skills/openclaw/deploy-nvblox/SKILL.md
     Licence: MIT
     Source:  https://github.com/Seeed-Projects/Seeed-Jetson-DevelopTool/blob/main/skills/openclaw/deploy-nvblox/SKILL.md
