<!-- Vendored from Seeed-Projects/Seeed-Jetson-DevelopTool @ main
     Path:    skills/openclaw/deploy-ollama-anythingllm/SKILL.md
     Licence: MIT
     Source:  https://github.com/Seeed-Projects/Seeed-Jetson-DevelopTool/blob/main/skills/openclaw/deploy-ollama-anythingllm/SKILL.md
...
## Source
- Original markdown: `/home/darklee/tmp/jetson-develop/refer-参考完后会清除/Application/Generative_AI/Deploy_Ollama_and_AnythingLLM_on_Jetson.md`
- Scope: `application` (Generative_AI)
