<!-- Vendored from NVIDIA-AI-IOT/inference_builder @ main
     Path:    skills/inference-builder/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/NVIDIA-AI-IOT/inference_builder/blob/main/skills/inference-builder/SKILL.md
