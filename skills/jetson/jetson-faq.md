<!-- Vendored from Seeed-Projects/Seeed-Jetson-DevelopTool @ main
     Path:    skills/openclaw/jetson-faq/SKILL.md
     Licence: MIT
     Source:  https://github.com/Seeed-Projects/Seeed-Jetson-DevelopTool/blob/main/skills/openclaw/jetson-faq/SKILL.md
...
→ See skill: `openclaw/jetpack-flash-wsl2` or Seeed wiki troubleshooting guide
...
→ See skill: `openclaw/usb-timeout-during-flashing`
...
→ See skill: `openclaw/jetpack5-ssd-boot-fix`

### Q14: How to build Seeed's Jetson BSP from source
→ See skill: `openclaw/bsp-source-build`
...
→ See skill: `openclaw/ko-module-build`
...
→ See skill: `openclaw/ethercat-communication`
