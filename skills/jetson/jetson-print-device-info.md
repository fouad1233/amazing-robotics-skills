<!-- Vendored from NVIDIA-AI-IOT/jetson-device-skills @ main
     Path:    skills/jetson-print-device-info/SKILL.md
     Licence: CC-BY-4.0
     Source:  https://github.com/NVIDIA-AI-IOT/jetson-device-skills/blob/main/skills/jetson-print-device-info/SKILL.md
