<!-- Vendored from NVIDIA-AI-IOT/jetson-device-skills @ main
     Path:    skills/jetson-speculative-decoding/SKILL.md
     Licence: CC-BY-4.0
     Source:  https://github.com/NVIDIA-AI-IOT/jetson-device-skills/blob/main/skills/jetson-speculative-decoding/SKILL.md
