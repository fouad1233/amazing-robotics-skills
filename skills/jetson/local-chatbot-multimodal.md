<!-- Vendored from Seeed-Projects/Seeed-Jetson-DevelopTool @ main
     Path:    skills/openclaw/local-chatbot-multimodal/SKILL.md
     Licence: MIT
     Source:  https://github.com/Seeed-Projects/Seeed-Jetson-DevelopTool/blob/main/skills/openclaw/local-chatbot-multimodal/SKILL.md
     Unmodified copy. See NOTICE for attribution. -->

---
name: local-chatbot-multimodal
description: Build a voice-interactive AI chatbot on Jetson using Ollama (LLM), NVIDIA Riva (STT/TTS), and Docker. Supports real-time speech-to-text, local LLM inference, and text-to-speech — fully offline with no cloud dependencies. Requires JetPack 6.0+ and NGC API key.
---
