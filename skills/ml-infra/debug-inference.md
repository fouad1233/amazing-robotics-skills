<!-- Vendored from NVIDIA/OpenShell @ main
     Path:    .agents/skills/debug-inference/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/NVIDIA/OpenShell/blob/main/.agents/skills/debug-inference/SKILL.md
