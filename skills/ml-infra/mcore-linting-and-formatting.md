<!-- Vendored from NVIDIA/Megatron-LM @ main
     Path:    skills/mcore-linting-and-formatting/SKILL.md
     Licence: BSD-3-Clause
     Source:  https://github.com/NVIDIA/Megatron-LM/blob/main/skills/mcore-linting-and-formatting/SKILL.md
