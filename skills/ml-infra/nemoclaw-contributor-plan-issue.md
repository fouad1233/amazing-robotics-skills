<!-- Vendored from NVIDIA/NemoClaw @ main
     Path:    .agents/skills/nemoclaw-contributor-plan-issue/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/NVIDIA/NemoClaw/blob/main/.agents/skills/nemoclaw-contributor-plan-issue/SKILL.md
