<!-- Vendored from NVIDIA/NemoClaw @ main
     Path:    .agents/skills/nemoclaw-contributor-update-docs/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/NVIDIA/NemoClaw/blob/main/.agents/skills/nemoclaw-contributor-update-docs/SKILL.md
