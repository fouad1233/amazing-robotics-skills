<!-- Vendored from NVIDIA/cudf @ main
     Path:    .agents/skills/review-cudf-polars-expressions/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/NVIDIA/cudf/blob/main/.agents/skills/review-cudf-polars-expressions/SKILL.md
