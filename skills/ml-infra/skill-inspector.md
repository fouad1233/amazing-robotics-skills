<!-- Vendored from NVIDIA/SkillSpector @ main
     Path:    skills/skill-inspector/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/NVIDIA/SkillSpector/blob/main/skills/skill-inspector/SKILL.md
