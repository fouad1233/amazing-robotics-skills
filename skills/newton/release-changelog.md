<!-- Vendored from newton-physics/newton @ main
     Path:    .claude/skills/release-changelog/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/newton-physics/newton/blob/main/.claude/skills/release-changelog/SKILL.md
