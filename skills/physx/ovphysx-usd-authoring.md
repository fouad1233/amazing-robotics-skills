<!-- Vendored from NVIDIA-Omniverse/PhysX @ main
     Path:    ovphysx/skills/ovphysx-usd-authoring/SKILL.md
     Licence: BSD-3-Clause
     Source:  https://github.com/NVIDIA-Omniverse/PhysX/blob/main/ovphysx/skills/ovphysx-usd-authoring/SKILL.md
