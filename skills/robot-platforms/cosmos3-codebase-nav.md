<!-- Vendored from nebius/nebius-physical-ai @ main
     Path:    skills/atomic/cosmos3-codebase-nav/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/nebius/nebius-physical-ai/blob/main/skills/atomic/cosmos3-codebase-nav/SKILL.md
...
SkyPilot task templates as skill launchers unless the product direction changes
to a real executable workflow.
