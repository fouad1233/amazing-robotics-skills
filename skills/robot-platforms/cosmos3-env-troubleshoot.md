<!-- Vendored from nebius/nebius-physical-ai @ main
     Path:    skills/atomic/cosmos3-env-troubleshoot/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/nebius/nebius-physical-ai/blob/main/skills/atomic/cosmos3-env-troubleshoot/SKILL.md
