<!-- Vendored from D-Robotics/moss @ main
     Path:    packages/moss-agent/assets/rdk-knowledge/skills/rdk-peripheral-cookbook/SKILL.md
     Licence: MIT
     Source:  https://github.com/D-Robotics/moss/blob/main/packages/moss-agent/assets/rdk-knowledge/skills/rdk-peripheral-cookbook/SKILL.md
