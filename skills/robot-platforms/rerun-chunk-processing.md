<!-- Vendored from rerun-io/trossen-oss @ main
     Path:    .agents/skills/rerun-chunk-processing/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/rerun-io/trossen-oss/blob/main/.agents/skills/rerun-chunk-processing/SKILL.md
