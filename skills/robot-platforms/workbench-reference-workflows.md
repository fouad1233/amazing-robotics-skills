<!-- Vendored from nebius/nebius-physical-ai @ main
     Path:    skills/workflows/workbench-reference-workflows/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/nebius/nebius-physical-ai/blob/main/skills/workflows/workbench-reference-workflows/SKILL.md
