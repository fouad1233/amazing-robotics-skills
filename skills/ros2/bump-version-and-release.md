<!-- Vendored from castacks/AirStack @ main
     Path:    .agents/skills/bump-version-and-release/SKILL.md
     Licence: MIT
     Source:  https://github.com/castacks/AirStack/blob/main/.agents/skills/bump-version-and-release/SKILL.md
