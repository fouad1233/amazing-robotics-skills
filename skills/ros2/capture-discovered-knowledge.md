<!-- Vendored from castacks/AirStack @ main
     Path:    .agents/skills/capture-discovered-knowledge/SKILL.md
     Licence: MIT
     Source:  https://github.com/castacks/AirStack/blob/main/.agents/skills/capture-discovered-knowledge/SKILL.md
