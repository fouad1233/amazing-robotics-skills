<!-- Vendored from castacks/AirStack @ main
     Path:    .agents/skills/integrate-module-into-layer/SKILL.md
     Licence: MIT
     Source:  https://github.com/castacks/AirStack/blob/main/.agents/skills/integrate-module-into-layer/SKILL.md
