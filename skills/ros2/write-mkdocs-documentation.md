<!-- Vendored from castacks/AirStack @ main
     Path:    .agents/skills/write-mkdocs-documentation/SKILL.md
     Licence: MIT
     Source:  https://github.com/castacks/AirStack/blob/main/.agents/skills/write-mkdocs-documentation/SKILL.md
