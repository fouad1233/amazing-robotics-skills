<!-- Vendored from rerun-io/rerun @ main
     Path:    skills/rerun-chunk-processing/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/rerun-io/rerun/blob/main/skills/rerun-chunk-processing/SKILL.md
