<!-- Vendored from NVIDIA/warp @ main
     Path:    .codex/skills/release-audit/SKILL.md
     Licence: Apache-2.0
     Source:  https://github.com/NVIDIA/warp/blob/main/.codex/skills/release-audit/SKILL.md
...
2. Read `CHANGELOG.md` from the selected `<head-ref>`, not from the current working tree:
   ```bash
